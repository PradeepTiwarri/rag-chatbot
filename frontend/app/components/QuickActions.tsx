    ...
    <div className="flex flex-wrap gap-2 mb-3">
      {actions.map((action) => (
        <button
          ...
          className="px-4 py-2 bg-white border border-surface-200 hover:border-accent-300 hover:bg-accent-50 rounded-full text-xs font-medium text-surface-700 transition-all"
        >
          {action.label}
        </button>
      ))}
